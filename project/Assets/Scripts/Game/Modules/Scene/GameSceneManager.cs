...
{
    UniTask OnLeaveScene(LoadItem item, Action UpdateLoading);
    UniTask OnEnterScene(LoadItem item, Action UpdateLoading);
}
...
public class SceneBehavior :ISceneBehavior
{
    ...
    private List<Action> clearFunc = new List<Action>();
    ...
    public async UniTask EnterScene(LoadItem item, Action UpdateLoading)
    {
        await OnEnterScene(item, UpdateLoading);
    }

    public async UniTask LeaveScene(LoadItem item, Action UpdateLoading)
    {
        clearCallback?.Invoke();
        clearCallback = null;
        await OnLeaveScene(item, UpdateLoading);
    }

    public virtual async UniTask OnEnterScene(LoadItem item, Action UpdateLoading)
    {
        await UniTask.CompletedTask;
    }

    public virtual async UniTask OnLeaveScene(LoadItem item, Action UpdateLoading)
    {
        await UniTask.CompletedTask;
    }
